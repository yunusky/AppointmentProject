        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_ServiceAreas_ServiceAreaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HolidayOffice", x => new { x.HolidaysId, x.OfficesId });
                    table.ForeignKey(
                        name: "FK_HolidayOffice_Holidays_HolidaysId",
                        column: x => x.HolidaysId,
                        principalTable: "Holidays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HolidayOffice_Offices_OfficesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressAppUser", x => new { x.AddressesId, x.UserAddressId });
                    table.ForeignKey(
                        name: "FK_AddressAppUser_Addresses_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddressAppUser_AspNetUsers_UserAddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressAppUser_UserAddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_ServiceAreaId",
                table: "Companies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HolidayOffice_OfficesId",
                table: "HolidayOffice",
                column: "OfficesId");
